...
values ('People Manager Toolkit', 'Learn how to manage little baby developers', 'Mandatory');
insert into training(name, description, trainingType
values ('SA Development', 'Learn the responsibilities required in your new role', 'Mandatory');
insert into training(name, description, trainingType)
values ('Kainos as a Business', 'Learn how Kainos business processes operate', 'Mandatory');
insert into training(name, description, trainingType)
values ('Influencing Others', 'Learn how to work with a team and positively influence your colleagues', 'Mandatory');
insert into training(name, description, trainingType)
values ('Coaching - Foundation', 'Learn the basics of mentoring and teaching colleagues', 'Mandatory');
insert into training(name, description, trainingType)
values ('Consultant Development', 'Learn the responsibilities required in your new role', 'Mandatory');
insert into training(name, description, trainingType)
values ('Certified Scrum Master', 'Learn how to lead an agile team', 'Mandatory');
...
insert into band_Training(bandID, trainingID) values (2, 2);
